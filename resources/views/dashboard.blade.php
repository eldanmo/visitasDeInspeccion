    ...
    <div class="container text-center">
        ...
        @if(Auth::user()->profile !== NULL)
            <div class="row text-center">
                    ...
                    <div class="col col-sm-5 col-md-5 col-lg-3 border border-primary text-center mr-3 mt-3 bg-primary">
                        <div class="row text-center p-3 justify-content-center">
                            ...
                            @if(Auth::user()->profile === 'Administrador' || Auth::user()->profile === 'Intendente')
                                <a href="{{ url('/crear_diagnostico') }}" class="col-10 col-sm-10 col-md-10 col-lg-4 border border-primary pt-3 m-3 pr-2 pl-2 text-center flex flex-col items-center bg-white" style="padding: 0 45px; text-decoration: none; color: inherit;">
                            ...
                            @endif
                            <a href="{{ url('/consultar_informe') }}"  class="col-10 col-sm-10 col-md-10 col-lg-4 border border-primary pt-3 m-3 text-center flex flex-col items-center bg-white" style="padding: 0 45px; text-decoration: none; color: inherit;">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                @if(Auth::user()->profile === 'Coordinador' || Auth::user()->profile === 'Administrador' )
                    <div class="col col-sm-5 col-md-5 col-lg-3 border border-success text-center mr-3 mt-3 bg-success">
                        <div class="row text-center p-3 justify-content-center">
                            ...
                            <a href="{{ url('/crear_entidad') }}" class="col-10 col-sm-10 col-md-10 col-lg-4 border border-success pt-3 m-3 text-center flex flex-col items-center bg-white" style="padding: 0 45px; text-decoration: none; color: inherit;">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                </svg>                   
                                <p>Crear</p>
                            </a>
                            <a href="{{ url('/consultar_entidad') }}"  class="col-10 col-sm-10 col-md-10 col-lg-4 border border-success pt-3 m-3 text-center flex flex-col items-center bg-white" style="padding: 0 45px; text-decoration: none; color: inherit;">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                                </svg>                        
                                <p>Consultar</p>
                ...
                @endif
                    <div class="col col-sm-5 col-md-5 col-lg-6 border border-warning text-center mr-3 mt-3 bg-warning">
                        <div class="row text-center p-3 justify-content-center">
                            <div class="col col-sm-12">
        ...
        @else
            <div class="row text-center">
                <h2>Sin perfil asignado, por favor comuniquese con el coordinador del grupo de inspección</h2>
            </div>
        @endif
    </div>
</x-app-layout>
